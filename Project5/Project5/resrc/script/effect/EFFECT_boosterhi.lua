...
boosterhi_id = manager:getEffect("booster_hi", "resrc/img/effect/boosterhi.png","resrc/script/effect/EFFECT_boosterhi.lua")
manager:deleteEffect(boosterhi_id)
manager:deleteEffectImpl()
manager:makeEffectPart(boosterhi_id, 0, "3000", false,"3000","3000")
manager:setEffectPartPos(boosterhi_id,0,"0","3000","0","0","0","0","0","0")
...
manager:setEffectPartWH(boosterhi_id,0,"0","3000","3","3","0.5","0.5")
manager:setEffectPartRot(boosterhi_id,0,"0","3000","0","0","0","0","0","0")
manager:setEffectPartColor(boosterhi_id,0,"0","3000",0xFFFFFFFF,0xFFFFFF22)
