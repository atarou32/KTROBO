 ...
 // if (t) {
  ...
  int au2_indexs_count = au2.index_count;
    ...
    if (true || at.is_majiwari) {
      ...
      ansBuf2[soreigai_idx+igaidousi_count].kouten_jyusin = float3(at.pos.x,at.pos.y,at.pos.z);
      ansBuf2[soreigai_idx+igaidousi_count].kouten_housen = float3(at.housen.x, at.housen.y, at.housen.z);
     return;
    }  
//  }
