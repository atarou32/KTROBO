...
ANS_MAJIWARITIKEITOSOREIGAI majiwariAtariTriangleToOBB(MESH_VERTEXKARI v1, MESH_VERTEXKARI v2, MESH_VERTEXKARI v3, AtariUnitOBB obb) {
  ...
  if (length(jyusin_tri1 - obb.c) > r_tri1 + obb.e[0]+obb.e[1]+obb.e[2]) return ans;
...
//			float3 ans_ten;
			...
			float3 tyu = obb.c + obb.u[i] * test * obb.e[i];
			if (i==0) {
