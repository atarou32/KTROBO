...
int soreigai_idx = struct_idx / 128;//KTROBO_MAX_TIKEI_HITOTU_INDEX;
int soreigai_index_idx = struct_idx % 128;//KTROBO_MAX_TIKEI_HITOTU_INDEX;
...
//  if (autts.atari_idx == autts.atari_idx2) return;
 ...
 ansBuf2[9000].is_use = 1;
      ansBuf2[9000].atari_idx = autts.atari_idx;
      ansBuf2[9000].atari_idx2 = autts.atari_idx2;
ansBuf2[9000].obb_idx=12345;
  if (t) {

      ansBuf2[soreigai_idx+igaidousi_count].is_use = 1;
      ansBuf2[soreigai_idx+igaidousi_count].atari_idx = autts.atari_idx;
      ansBuf2[soreigai_idx+igaidousi_count].atari_idx2 = autts.atari_idx2;
      ansBuf2[soreigai_idx+igaidousi_count].obb_idx = 23456;
  ...
  int au2_indexs_count = au2.index_count;
   ...
   // if (3*i > au2_indexs_count) return;
/*
...
*/
 //   if (true) {// || at.is_majiwari) {
      ansBuf2[soreigai_idx+igaidousi_count].is_use = 1;
      ansBuf2[soreigai_idx+igaidousi_count].atari_idx = autts.atari_idx;
      ansBuf2[soreigai_idx+igaidousi_count].atari_idx2 = autts.atari_idx2;
      ansBuf2[soreigai_idx+igaidousi_count].obb_idx = autts.obb_idx;
      ansBuf2[soreigai_idx+igaidousi_count].obb_idx2 = 0;
      ansBuf2[soreigai_idx+igaidousi_count].kouten_jyusin = float3(1,1,1);//float3(at.pos.x,at.pos.y,at.pos.z);
      ansBuf2[soreigai_idx+igaidousi_count].kouten_housen = float3(2,2,2);//float3(at.housen.x, at.housen.y, at.housen.z);
     return;
  //  }  
  }
