...
if MYSLIDERS == nil then
  ...
  MYSLIDERS[5] = gu:makeInputText("120","500","180","20")
  MYSLIDERS[6] = gu:makeWindow(120,500,240,30)
  MYSLIDERS[7] = gu:makeButton("380","500","40","20","resrc/script/AE_setAkatToActionBut.lua",38,"set")
  ...
  gu:setPartToWindow(win3, MYSLIDERS[6])
  gu:setPartToWindow(win3, MYSLIDERS[3])
