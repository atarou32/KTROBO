...
GUI_INPUTTEXT::GUI_INPUTTEXT(float x, float y, float width, float height, Texture* tex, HWND hwnd) {
	...
	is_render = true;
	is_effect = false;
	this->box_tex_id_naka = tex->getRenderTex(tex_id, 0xFFFFFFFF,x + KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,y + KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
		width- 2* KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,height- 2 * KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
	...
	box_tex_id_hidariue = tex->getRenderTex(tex_id, 0xFFFFFFFF, x,y,KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
	...
	box_tex_id_hidarinaka  = tex->getRenderTex(tex_id, 0xFFFFFFFF, x,y+KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
		KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,height - 2 * KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
	...
	box_tex_id_hidarisita = tex->getRenderTex(tex_id, 0xFFFFFFFF, x,y+height - KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
	...
	box_tex_id_migiue = tex->getRenderTex(tex_id, 0xFFFFFFFF,x+width-KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,y,
		KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,KTROBO_GUI_INPUTTEXT_NORMAL_LEFT+KTROBO_GUI_INPUTTEXT_NORMAL_WIDTH-
	...
	box_tex_id_miginaka = tex->getRenderTex(tex_id, 0xFFFFFFFF, x+width-KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,y+KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
		KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,height- KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA*2,
	...
	box_tex_id_migisita =  tex->getRenderTex(tex_id, 0xFFFFFFFF, x+width-KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
		y+height - KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
		KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
	...
	box_tex_id_sitanaka = tex->getRenderTex(tex_id, 0xFFFFFFFF, x+KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
		y,width - 2 * KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA, KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA, KTROBO_GUI_INPUTTEXT_NORMAL_LEFT+KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
	...
	box_tex_id_uenaka = tex->getRenderTex(tex_id, 0xFFFFFFFF, x+KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
		y+height - KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,width - 2 * KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA, 
		KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA, KTROBO_GUI_INPUTTEXT_NORMAL_LEFT+KTROBO_GUI_INPUTTEXT_BOX_SOTOHABA,
